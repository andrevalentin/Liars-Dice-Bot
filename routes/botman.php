...
$botman->hears('close game', \App\Http\Controllers\LiarsDiceBotController::class.'@handle');
$botman->hears('me', \App\Http\Controllers\LiarsDiceBotController::class.'@handle');
$botman->hears('leave', \App\Http\Controllers\LiarsDiceBotController::class.'@handle');
